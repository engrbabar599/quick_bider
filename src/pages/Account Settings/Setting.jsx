        ...
        <>
          <div className="pt-6">
            ...
            <form className="space-y-4">
              ...
              <div className="text-center">
                <button className="mx-auto bg-blue text-white px-8 py-2 rounded-lg hover:bg-blue-600">
                  Update password
                </button>
              </div>
            </form>
        ...
        <>
          <div className="pt-6">
            ...
            <form className="space-y-4">
              ...
              <div className="text-center">
                <button className="mx-auto bg-blue text-white px-8 py-3 rounded-lg hover:bg-blue-600">
                  Update bank details
                </button>
              </div>
            </form>
