...
function MyBids() {
  ...
  const handleFirstButtonClick = (item) => {
    setActiveTab(item);
  };
    ...
    <>
      <div className="p-6">
        ...
        <div className="flex gap-4 py-4 justify-center md:justify-start">
          <div>
            <button
              onClick={()=>{handleFirstButtonClick("first")}}
              className={`px-5 py-2 font-semibold rounded-xl text-sm font-poppins ${activeTab === "first"
          ...
          <div>
            <button
              onClick={()=>{handleFirstButtonClick("second")}}
              className={`px-5 py-2 font-semibold rounded-xl text-sm font-poppins ${activeTab === "second"
                ? "bg-blue-500 text-white"
                : "text-gray-400 border border-gray-400"
                }`}
            >
