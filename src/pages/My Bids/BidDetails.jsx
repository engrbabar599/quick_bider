      ...
      <div className="cardspart grid xs:grid-cols-1 lg:grid-cols-12 gap-5 p-5">
        ...
        <div className=" xs:col-span-8 md:col-span-8 lg:col-span-4 ">
          ...
          <div className="rightbottom py-6">
            ...
            <div className="border rounded-xl shadow-sm flex justify-between items-center p-4">
                <div className="left flex items-center">
                    <div className="bid1">
                        <h1>Bid 1</h1>
                    </div>
                    <div className="robertouter">
                        <div className="robert flex">
                            <div>
                                <h1>Robert Fox</h1>
                            </div>
                            <div><h1>(Rank 3)</h1></div>
                        </div>
                        <div className="time flex">
                            <div><h1>Time:</h1></div>
                            <div><h1>10:10:20 AM</h1></div>
                        </div>
                    </div>
                </div>
