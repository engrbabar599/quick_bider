...
function BidDetails() {
  ...
  return (
    <div className="cardspart grid grid-cols-1 lg:grid-cols-12 gap-5 p-5">
      {cards.map((card, index) => (
        <div key={index} className="card border rounded-3xl p-8 shadow-sm col-span-12 lg:col-span-8">
          <div className="cars flex items-center justify-center gap-5">
            <div
            ...
            >
              <img
                src={car1}
                className={`${activeTab === "first" ? "scale-110" : ""} hidden md:block`}
                alt="car1"
              />
            ...
            >
              <img
                src={car2}
                className={`${activeTab === "second" ? "scale-110" : ""}`}
                alt="car2"
              />
            ...
            >
              <img
                src={car3}
                className={`${activeTab === "third" ? "scale-110" : ""} hidden md:block`}
                alt="car3"
              />
          ...
          <div className="text-center w-[40vw] mx-auto py-5 hidden md:block">
            <p>
              We are delighted to offer you a wide range of vehicles
              through our auction platform. Whether you're looking for a
              new ride or seeking a classic gem, our auctions provide you
          ...
          <div className="flex justify-between py-8 md:hidden">
            <h1 className="opacity-60">Date</h1>
            <h1 className="font-bold">25/06/2024</h1>
          </div>
          ...
          <div className="hidden md:flex justify-center items-center gap-10 p-5">
            ...
            <div className="border rounded-xl p-3 w-[20%] flex flex-col items-center">
              ...
              <h1 className="font-semibold opacity-60">Participants</h1>
            </div>
            <div className="border rounded-xl p-2 w-[20%] flex flex-col items-center">
      ...
      <div className="col-span-12 lg:col-span-4">
        ...
        <div className="pt-5">
          <div className="border rounded-xl p-5 shadow-lg">
            ...
            {investment.map((value, i) => (
              <div key={i} className="grid grid-cols-3 pt-3 border-b py-2 hover:bg-[#E2EBFF]">
                <div>{value.name}</div>
                <div>10:20:40 AM</div>
                <div>AB</div>
              </div>
        ...
        <div className="rightbottom py-6">
          ...
          {myBids.map((bid, i) => (
            <div key={i} className="border rounded-xl shadow-sm flex justify-between items-center p-4 my-5">
              <div className="left flex items-center gap-4">
                <div className="bid1">
                  <h1 className="font-semibold text-blue text-base">{bid.name}</h1>
                </div>
                <div className="robertouter flex flex-col gap-3">
                  <div className="robert flex items-center">
                    <h1 className="font-bold">Robert Fox</h1>
                  ...
                  <div className="time flex gap-1">
                    <h1 className="opacity-70">Time:</h1>
                    <h1 className="font-bold">{bid.time}</h1>
                  </div>
                </div>
              </div>
              <div className="right flex items-center gap-3">
                <img src={stars} alt="stars" />
                <div className="score">
                  <h1 className="font-bold">{bid.score}</h1>
                  <h1 className="opacity-70">Score</h1>
                </div>
              </div>
            </div>
      ...
      <div className="leftpart col-span-12">
        <div className="py-5">
          <h1 className="text-xl font-semibold">Terms & conditions</h1>
        </div>
        <div className="border p-5 rounded-xl">
