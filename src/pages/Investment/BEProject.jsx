            ...
            <div className="border rounded-xl p-5 my-6 shadow-sm md:w-[90%]">
              <div className="flex justify-between">
                ...
                <div className="flex gap-1">
                  ...
                  <h1 className="text-blue font-bold">%500</h1>
                </div>
              </div>
            ...
            <div className=" pt-3 flex gap-4 items-center">
              ...
              <div>
                <button
                  ...
                  className="bg-blue text-white px-3 py-3 rounded-lg"
                >
                  Add money
                </button>
            ...
            <div className="pt-5">
              <div className="border rounded-xl p-5">
                ...
                <div className="text-center py-5">
                  <button className="px-4 py-2 rounded-lg border border-blue text-blue">
                    View all
                  </button>
                </div>
              </div>
