...
export const BidsDetailsPage = () => {
  ...
  const { data: sdf } = useGetUserProfile()
  ...
  return (
    <DashboardLayout activeSidebar={"Dashboard"}>
      <div className='xl:grid xl:grid-cols-5 flex flex-col gap-8 '>
        ...
        {console.log(state?.auctionDetails)}
        <div className='lg:col-span-3 flex flex-col gap-6 relative '>
          ...
          <div className='flex flex-row items-center gap-x-2'>
            ...
            <div className='flex flex-row font-poppins font-normal  text-base'>
              <p onClick={() => navigate(-1)}
                ...
                {state?.auctionDetails?.from ? state?.auctionDetails?.from : "Dashboard"}
                /</p>
              <p className='font-semibold text-custom-blue'>{state?.auctionDetails?.title}</p>
            </div>
          </div>
          ...
          <div className="bg-white border  shadow-sm rounded-xl flex flex-col  lg:px-10 p-5 gap-7 items-center">
            ...
            <h2 className='font-heading !text-lg text-center'>
              {state?.auctionDetails?.title}({bidRound}{getOrdinalSuffix(bidRound)} round bid)
            </h2>
                ...
                {Array(3).fill().map((_, index) => (
                  <div
                    ...
                    <img
                      ...
                      alt="" className='rounded-xl group-hover:scale-105 group-hover:ease-in group-hover:duration-300 h-[124px] w-[200px] object-contain' />
                    <div className='w-full border-4 rounded-xl group-hover:border-custom-blue'></div>
                  </div>
                ))}
              </div>

              <img src={state?.auctionDetails?.thumbnail_image} alt="" className='!rounded-xl md:hidden w-[250px] h-[188px] object-cover' />
            ...
            <div className='flex flex-col gap-4 lg:w-4/5 w-full'>
              ...
              <div className='flex flex-wrap items-center justify-center flex-row lg:gap-6 gap-4 h-full w-full'>
                ...
                <div className='border border-gray-5 py-2  flex flex-col items-center justify-center rounded-xl lg:w-28 w-20 h-full gap-2 '>
                  ...
                  <div className='flex flex-col font-poppins items-center'>
                    <p className='text-gray-1 font-semibold lg:text-xl text-sm '>{state?.auctionDetails?.participants?.length}</p>
                ...
                <div className='border border-gray-5 py-2  flex flex-col items-center justify-center rounded-xl lg:w-28 w-20 h-full gap-2'>
                  ...
                  <div className='flex flex-col font-poppins items-center'>
                    <p className='text-gray-1 font-semibold lg:text-xl text-sm'>{state?.auctionDetails?.auction_minutes}</p>
