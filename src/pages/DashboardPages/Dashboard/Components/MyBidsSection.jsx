...
export const MyBidsSection = () => {
    ...
    const { data: investmentData } = useGetUserInvestment({ is_active: true })
                ...
                <div className='flex flex-col gap-5 font-poppins'>
                    ...
                    <div className='hidden lg:flex gap-4  flex-row items-center '>
                        {Array(3).fill().map((_, index) => (
                            <div key={index}
                                className={`${index === 1 ? "" : ""}  `}>
                                <img src={IMAGES?.mybids1} alt="" className='object-cover rounded-xl ' />
                            </div>
                        ))}
                    </div>
                    <div className='flex items-center justify-center'>
                        <img src={IMAGES?.mybids1} alt="" className='object-contain lg:hidden w-[240px] h-[240px] ' />
                    </div>
