        ...
        <div className='col-span-12 lg:col-span-5'>
          {userProfile?.active_investment ?
            ...
            <div className='flex flex-col gap-4 w-full h-full'>
              ...
              <div className='flex flex-col bg-custom-blue bg-opacity-10 h-full w-full items-center justify-center px-8 py-8 gap-4 rounded-xl'>
                <h3 className='text-center  md:text-xl font-medium text-gray-2'>
