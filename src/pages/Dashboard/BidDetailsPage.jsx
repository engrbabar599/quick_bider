  ...
  return (
    <div className='xl:grid xl:grid-cols-5 flex flex-col gap-8 '>
      ...
      <div className='lg:col-span-3 flex flex-col gap-6 relative'>
        ...
        <div className='flex flex-row items-center gap-x-2'>
          ...
          <div className='flex flex-row font-poppins font-normal  text-base'>
            <p onClick={() => navigate(-1)} className='text-gray-1  hover:cursor-pointer hover:text-black'>Dashboard/</p>
        ...
        <div className="bg-white border  shadow-sm rounded-xl flex flex-col  lg:px-10 p-5 gap-7 items-center">
          ...
          <h2 className='font-heading !text-lg text-center'>
            Ford Mustang({bidRound}{bidRound === 1 ? "st" :
              bidRound === 2 ? "nd" :
                bidRound === 3 ? "rd" :
                  "th"} round bid)
          </h2>
      ...
      <div className="lg:col-span-2 flex flex-col gap-8">
          ...
          <div className='flex flex-col border shadow-md rounded-2xl lg:p-8 p-4 gap-5 w-full items-center'>
            ...
            <div className='divide-y-2 w-full '>
              {Array(6).fill().map((_, index) => (
                <div
                  key={index}
                  className='flex flex-row justify-between items-center text-justify font-poppins py-2 font-light lg:text-base text-sm text-gray-4'>
        ...
        {/* My bids */}
        <div className={`flex flex-col gap-8`}>
          <div className={`${bidRound === 1 ? "hidden" : "flex"}  flex-col gap-6`}>
