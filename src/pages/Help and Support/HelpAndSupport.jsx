  ...
  return (
    <>
      <div className=" mx-auto md:p-4">
        <div className="border rounded p-4 md:grid gap-6 md:grid-cols-3 flex flex-col">
          ...
          <div className="space-y-4">
            <div className="border p-4 rounded-md flex items-center shadow gap-5 cursor-pointer">
              ...
              <div>
                ...
                <p className="text-custom-blue md:text-xs lg:text-base">support@quickbet.com</p>
              </div>
            </div>
